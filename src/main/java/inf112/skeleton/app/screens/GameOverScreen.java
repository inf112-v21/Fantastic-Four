...
public class GameOverScreen implements Screen {
	...
	private final BitmapFont fontLabelBig;
	...
	public GameOverScreen(RoboGame roboGame) {
		...
		ImageTextButton button1 = new ImageTextButton("OK", imageTextButtonStyle);
		button1.setX(170);
		button1.setY(80);
		...
		ImageTextButton button2 = new ImageTextButton("Cancel", imageTextButtonStyle);
		button2.setX(320);
		button2.setY(80);
